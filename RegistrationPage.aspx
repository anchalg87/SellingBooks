...
<body>
   ...
   <div>
    ...
    <asp:Label ID="Label1" runat="server" Text="Just few steps..." style="font-size:22px;background-color:gold" width="100%"></asp:Label>
     ...
     <tr Height="100%">
      <td style="background-color:goldenrod">
        <table>
            ...
            <tr>
                <td colspan="3"><span>Tell us a little about yourself. This information is <b>only</b> used so we can <b>pay</b> you, provide a <b>free shipping label,</b> and <b>communicate with you.</b></span></td>
            </tr>
            <tr>
                <td width="80px"><asp:Label ID="lblName" runat="server" Text="Your Name"></asp:Label></td>
                <td width="20px"><span><font color="Red">*</font></span></td>
                <td><asp:TextBox ID="txtName" runat="server" Width="400px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="vldName" runat="server" ForeColor="Red" Font-Size="Small" ErrorMessage="The name is a Required Field." ValidationGroup="registerValidation" ControlToValidate="txtName"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
        ...
        <table>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtEmailAdd" runat="server" Width="400px"></asp:TextBox>
            ...
            <tr>
                <td width="100px" colspan="2"><asp:Label ID="lblPassword" runat="server" Text="Password"></asp:Label>&nbsp;&nbsp;<font color="Red">*</font></span></td>
            ...
            <tr>
                <td colspan="2"><asp:Label ID="lblConfirmPassword" runat="server" Text="Confirm Password"></asp:Label><font color="Red">*</font></span></td>
                <td><asp:TextBox ID="txtConfirmPassword" runat="server" Width="400px"  TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="vldConfirmPassword" runat="server" ForeColor="Red" Font-Size="Small" ErrorMessage="The confirm password is a Required Field." ValidationGroup="registerValidation" ControlToValidate="txtConfirmPassword"></asp:RequiredFieldValidator>
        ...
        <table>
            ...
            <tr>
                <td><asp:RadioButton ID="rdoCheck" runat="server" GroupName="Payment" Checked="true" /></td>
                <td><span>Check</span></td>
                <td><asp:RadioButton ID="rdoPayPal" runat="server" GroupName="Payment" /></td>
                <td><span>Paypal</span></td>
            </tr>
            <tr>
                <td></td>
                <td><asp:Button ID="btnMainPage" runat="server" Text="Go to Main Page" onClick="btnMainPage_Clicked" /></td>
                <td></td>
                <td><asp:Button ID="btnRegister" runat="server" ValidationGroup="registerValidation" Text="Complete Registration" OnClick="btnRegister_Clicked" /></td>
            </tr>
        </table>
        </td>
        <td style="vertical-align:top;background-color:darkgoldenrod">
        <table>
            <tr>
                <td colspan="3"><span style="font-size:20px">Already Have an Account?</span></td>
            </tr>
            <tr>
                <td colspan="3"><span style="font-size:18px">Login</span></td>
            </tr>
            <tr>
                <td colspan="2"><asp:Label ID="lblLoginID" runat="server" Text="Email Address"></asp:Label><font color="Red">*</font></span></td>
                <td><asp:TextBox ID="txtLoginID" runat="server" Width="200px"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2"><asp:Label ID="lblPassword2" runat="server" Text="Password"></asp:Label><font color="Red">*</font></span></td>
                <td><asp:TextBox ID="txtPassword2" runat="server" Width="200px" TextMode="Password"></asp:TextBox></td>
            </tr>
            <tr>
                <td><asp:Button ID="btnLogIn" runat="server" Text="Log In" OnClick="btnLogIn_Clicked" ValidationGroup="loginValidation" /></td>
                <td></td>
                <td><asp:Button ID="btnForgetPassword" runat="server" Text="Forgot Password" onClick="btnForgetPassword_Clicked" /></td>
            </tr>
            <tr>
                <td><asp:RequiredFieldValidator ID="vldLoginID" runat="server" ForeColor="Red" Font-Size="Small" ErrorMessage="Please enter a LoginID." ValidationGroup="loginValidation" ControlToValidate="txtLoginID"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td><asp:RequiredFieldValidator ID="vldPassword2" runat="server" ForeColor="Red" Font-Size="Small" ErrorMessage="Please enter a password." ValidationGroup="loginValidation" ControlToValidate="txtPassword2"></asp:RequiredFieldValidator></td>
            </tr>
        </table>
        </td>
        </tr>
